...
2. **Configurer le fichier pom.xml**
   ...
   * Ajouter la dépendance JSON dans `<dependencies>` :
     ...
     ```
Puis faîtes clic-droit dans le fichier pom.xml, puis "Reload Projects" (ou Maj + Alt + U si vous ne voyez pas Reload Projects). Ca téléchargera les nouvelles dépendances.
